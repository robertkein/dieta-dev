...
<div id="page-wrapper">
  <div id="page">
    <header id="header" role="banner" class="clearfix">
      <?php if ($page['headertop']): ?>
        <div class="header-top"><?php print render($page['headertop']); ?></div><div class="clear"></div>
      <?php endif; ?>
      <div class="section-1 clearfix">
        <div class="header-wrapper clearfix">
          <?php if ($page['menu_left']): ?>
            <div class="menu-left"><?php print render($page['menu_left']); ?></div>
          <?php endif; ?>
          <?php if ($page['menu']): ?><div class="col2"><?php print render($page['menu']); ?></div><?php endif; ?>
          <div class="col1">
